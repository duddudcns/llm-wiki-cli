...
5. Capture a stated preference or convention the moment it comes up, without waiting to be asked — a `.codex/rules/` edit for a small always-apply rule, a wiki entry (step 3) for a decision with a "why." Mention briefly what got recorded.
